...
insert into course(mentor_id,course_name,course_start,course_end,course_price,course_desc,max_limit) values(1,'data structures','2024-01-03','2024-03-29','500','A complete beginnner to advanced data structures course',5);
